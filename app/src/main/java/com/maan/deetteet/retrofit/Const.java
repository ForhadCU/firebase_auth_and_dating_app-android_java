...
public final class Const {
    public static final String BASE_URL = "https:/deetteet.com/api/";
    public static final String IMAGE_URL = "https:/deetteet.com/uploads/";
    public static final String DEV_KEY = "lives!123";
